...
namespace Script.Utilities.Property_Drawers.Editor
{
    [CustomPropertyDrawer(typeof(ItemCodeDesAttribute))]
    public class ItemCodeDesDrawer : PropertyDrawer
    {
        ...
        {
            var soItemList =
                AssetDatabase.LoadAssetAtPath("Assets/Scriptable Object Assets/Item/so_ItemList.asset",
